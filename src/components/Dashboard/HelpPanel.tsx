...
import { Sparkles, Mic, PartyPopper, Armchair, Minus, Square } from 'lucide-react';
...
export const HelpPanel: React.FC<HelpPanelProps> = ({ showHelp }) => {
  ...
  return (
    <motion.div
      ...
      className={`glass-panel p-4 md:p-5 rounded-2xl w-full shadow-md pointer-events-auto border border-white select-none transition-all duration-300 flex flex-col ${isMinimized ? 'h-14 overflow-hidden' : ''}`}
    >
